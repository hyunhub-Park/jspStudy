		...
		<form name="regForm" method="post" action="modifyProc.do">
			<table border="1" align="center">
				...
				<tr>
					...
					<td><input type="text" name="phone1" size="4" value="${svo.getPhone1()}" /> - <input type="text" name="phone2" size="5" value="${svo.getPhone2()}" /> - <input type="text" name="phone3" size="5" value="${svo.getPhone3()}" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="zipcode" value="${svo.getZipcode()}" /> <input type="button" value="찾기" onClick="zipCheck()" /></td>
				</tr>
				<tr>
					<td align="right">주소1 :</td>
					<td><input type="text" name="address1" size="50" value="${svo.getAddress1()}>" /></td>
				</tr>
				<tr>
					<td align="right">주소2 :</td>
					<td><input type="text" name="address2" size="30" value="${svo.getAddress2()}" /></td>
				</tr>
				<tr>
